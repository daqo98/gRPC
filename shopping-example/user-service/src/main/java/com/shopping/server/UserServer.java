...
public class UserServer {
    ...
    private Server server; // Server from the io.grcp package
            ...
            Runtime.getRuntime().addShutdownHook(new Thread(){
                ...
                public void run() {
                    ...
                    try {
                        ...
                        logger.log(Level.SEVERE, "Server shutdown interrrupted", exception);
                    }
                }
            });
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // To kill the main thread once the execution of the main method gets completed, don't stop abruptly
        userServer.blockUntilShutdown();
        //java -jar <path of jar>
        //changes in pom.xml:
        //add a plugin to create a fat jar
        //add the main method class
        //add the resources folder to the jar
